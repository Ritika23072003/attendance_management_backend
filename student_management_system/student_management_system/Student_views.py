...
from app.models import Student_Notification,Student,Student_feedback,Student_leave,Subject,Attendance,Attendance_Report,Course,StudentResult
...
def STUDENT_LEAVE(request):
    ...
    return render(request,'Student/apply_leave.html',contex)
